...
import NewsDetails01 from "../assets/images/resource/news-details.jpg";
import NewsDetails02 from "../assets/images/resource/author-2.jpg";
import NewsDetails03 from "../assets/images/resource/author-3.jpg";
import NewsDetails04 from "../assets/images/resource/news-23.jpg";
import NewsDetails05 from "../assets/images/resource/news-24.jpg";
import NewsDetails06 from "../assets/images/resource/news-25.jpg";
                ...
                <div className="col-xl-8 col-lg-7">
                    <div className="blog-details__left">
                        <div className="blog-details__img">
                            <img src={NewsDetails01} alt="Image"/>
                        ...
                        <div className="comment-one">
                            ...
                            <div className="comment-one__single">
                                <div className="comment-one__image"> <img src={NewsDetails02} alt="Image"/> </div>
                            ...
                            <div className="comment-one__single">
                                <div className="comment-one__image"> <img src={NewsDetails03} alt="Image"/> </div>
                                <div className="comment-one__content">
                                    <h3>Sarah Albert</h3>
                                    <p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla.
                                        Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla,
                    ...
                    <div className="sidebar">
                        ...
                        <div className="sidebar__single sidebar__post">
                            ...
                            <ul className="sidebar__post-list list-unstyled">
                                <li>
                                    <div className="sidebar__post-image"> <img src={NewsDetails04} alt="Image"/> </div>
                                ...
                                <li>
                                    <div className="sidebar__post-image"> <img src={NewsDetails05} alt="Image"/> </div>
                                    <div className="sidebar__post-content">
                                ...
                                <li>
                                    <div className="sidebar__post-image"> <img src={NewsDetails06} alt="Image"/> </div>
                                    <div className="sidebar__post-content">
                        ...
                        <div className="sidebar__single sidebar__category">
                            ...
                            <ul className="sidebar__category-list list-unstyled">
                                <li><Link to="/news-details">Business<span className="lnr-icon-arrow-right"></span></Link> </li>
                                <li className="active"><Link to="/news-details">Digital Agency<span className="lnr-icon-arrow-right"></span></Link></li>
                                <li><Link to="/news-details">Introductions<span className="lnr-icon-arrow-right"></span></Link> </li>
                                <li><Link to="/news-details">New Technologies<span className="lnr-icon-arrow-right"></span></Link> </li>
                                <li><Link to="/news-details">Parallax Effects<span className="lnr-icon-arrow-right"></span></Link> </li>
                                <li><Link to="/news-details">Web Development<span className="lnr-icon-arrow-right"></span></Link> </li>
                            </ul>
                        </div>
